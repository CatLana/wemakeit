        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-1" role="list">
              ...
              <li>
                <Link href="/work" className="block py-2 text-sm hover:text-[#22D3EE] transition-colors focus-visible:outline-2 focus-visible:outline-[#22D3EE] focus-visible:outline-offset-2 rounded">
                  {t("companyLinks.ourWork")}
                </Link>
              </li>
              <li>
