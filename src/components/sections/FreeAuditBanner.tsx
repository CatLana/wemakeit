      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mx-auto">
            We are looking to connect with business owners, from early entrepreneurs to established companies, who want to grow their revenue and improve how their business runs online. Let&rsquo;s connect!
          </p>
        </div>
