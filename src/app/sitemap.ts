...
const pages: {
  ...
  { path: "/blog/turn-business-problem-into-digital-solution", priority: 0.7, changeFrequency: "monthly", lastModified: new Date("2026-05-01") },
  { path: "/blog/have-an-idea-worth-building", priority: 0.7, changeFrequency: "monthly", lastModified: new Date("2026-05-01") },
  { path: "/blog/website-that-works-for-your-users", priority: 0.7, changeFrequency: "monthly", lastModified: new Date("2026-05-01") },
  ...
  { path: "/services/web-development",               priority: 0.8, changeFrequency: "monthly", lastModified: new Date("2026-04-30") },
  { path: "/services/app-development",               priority: 0.8, changeFrequency: "monthly", lastModified: new Date("2026-04-30") },
  { path: "/services/mobile-app-development",        priority: 0.8, changeFrequency: "monthly", lastModified: new Date("2026-04-30") },
  ...
  { path: "/services/ux-design",                     priority: 0.7, changeFrequency: "monthly", lastModified: new Date("2026-04-30") },
  { path: "/services/ux-research",                   priority: 0.7, changeFrequency: "monthly", lastModified: new Date("2026-04-30") },
  { path: "/services/ux-accessibility-audit",        priority: 0.7, changeFrequency: "monthly", lastModified: new Date("2026-04-30") },
  { path: "/services/maintenance-support",           priority: 0.7, changeFrequency: "monthly", lastModified: new Date("2026-04-30") },
  { path: "/services/localisation",                  priority: 0.6, changeFrequency: "monthly", lastModified: new Date("2026-04-30") },
