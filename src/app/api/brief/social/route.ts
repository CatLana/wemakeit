      ...
      <table width="600" cellPadding="0" cellSpacing="0" style="background:#fff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0;">
        <tr>
          <td style="background:#0f172a;padding:28px 32px;">
            ...
            <p style="margin:8px 0 0;font-size:13px;color:#94a3b8;">New social media brief from wemakeit.ie</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="padding:0 32px 24px;">
            <p style="font-size:12px;color:#94a3b8;margin:0;">This email was sent from the social media brief form at wemakeit.ie</p>
          </td>
        </tr>
      </table>
    </td></tr>
...
export async function POST(req: NextRequest) {
  ...
  const subject = data.name ? `Social media brief from ${data.name}` : "New social media brief";
  ...
  if (error) {
    console.error("Resend error (social brief):", error);
