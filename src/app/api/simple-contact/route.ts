      ...
      <table width="600" cellPadding="0" cellSpacing="0" style="background:#fff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0;">
        <tr>
          <td style="background:#0f172a;padding:28px 32px;">
            ...
            <p style="margin:8px 0 0;font-size:13px;color:#94a3b8;">New contact message from wemakeit.ie</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="padding:0 32px 32px;">
            <a href="mailto:${data.email}?subject=Re: Your message to We Make IT&body=Hi ${data.name},%0D%0A%0D%0AThank you for getting in touch..."
