...
const WebsiteBriefForm = dynamic(() => import("@/components/WebsiteBriefForm"));
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "websiteBrief" });
  const canonicalUrl = `${BASE_URL}/${locale}/brief/website`;
  ...
  return (
    <>
      ...
      <main id="main-content" tabIndex={-1} className="bg-[#F8FAFC]">
        ...
        <AudioBriefSection namespace="websiteBrief" />
      </main>
      <Footer />
    </>
  );
