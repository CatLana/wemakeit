...
const SoftwareBriefForm = dynamic(() => import("@/components/SoftwareBriefForm"));
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "softwareBrief" });
  const canonicalUrl = `${BASE_URL}/${locale}/brief/software`;
  ...
  return (
    <>
      ...
      <main id="main-content" tabIndex={-1} className="bg-[#F8FAFC]">
        ...
        <AudioBriefSection namespace="softwareBrief" />
      </main>
      <Footer />
    </>
  );
