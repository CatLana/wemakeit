...
export async function generateMetadata({
  ...
  const title = "Websites and Applications Development that Grow Your Business | We Make IT";
  const description = "Custom digital solutions to improve your online presence. Free consultations and technical audits. Over 15 years of experience in IT, fixed pricing.";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "We Make IT: Web and App Development Ireland",
        },
      ],
    },
    twitter: {
