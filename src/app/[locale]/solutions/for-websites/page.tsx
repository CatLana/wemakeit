...
const SLUG = "solutions/for-websites";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "valuePropWebsitesPage.metadata" });
...
export default async function ValuePropWebsitesPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const t = await getTranslations({ locale, namespace: "valuePropWebsitesPage" });
