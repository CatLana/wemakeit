...
const SLUG = "solutions/for-entrepreneurs";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "solutionsEntrepreneursPage.metadata",
  });
...
export default async function EntrepreneursPage({
  ...
  const t = await getTranslations({
    locale,
    namespace: "solutionsEntrepreneursPage",
  });
  ...
  const jsonLd = {
    ...
    "@type": "Service",
    name: "Website Services for Small Entrepreneurs",
